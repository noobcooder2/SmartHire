...
const Navbar = () => {
  ...
  return (
    <nav className="bg-blue-700 dark:bg-gray-900 text-white px-6 py-4 flex justify-between items-center shadow-md transition-colors">
      ...
      <div className="flex items-center gap-6">
        ...
        {user ? (
          ...
          <div className="flex gap-3">
            ...
            <Link to="/register" className="bg-yellow-400 text-blue-900 px-4 py-2 rounded-full font-semibold text-sm hover:bg-yellow-300 transition">
              Register
            </Link>
          </div>
        )}
